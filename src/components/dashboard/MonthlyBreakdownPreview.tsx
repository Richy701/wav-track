          ...
          <div className="flex flex-col p-6 relative z-10">
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <h3 className="text-lg font-bold bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
                    Monthly Breakdown
                  </h3>
              ...
              <div className="p-2.5 rounded-xl bg-purple-500/10 text-purple-400/90 ring-1 ring-purple-500/20">
            ...
            <div className="mb-6">
              <div className="flex justify-between mb-2">
                ...
                <span className="text-xs font-medium text-purple-400/90">{averageBeats} beats</span>
              </div>
              <div className="w-full h-2 bg-white/[0.03] rounded-full overflow-hidden backdrop-blur-lg">
                <motion.div 
                  initial={{ width: 0 }}
