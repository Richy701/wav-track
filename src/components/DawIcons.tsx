...
export const FLStudioIcon: React.FC<DawIconProps> = ({ className }) => (
  <img src="/assets/daw-logos/fl-studio.png" alt="FL Studio" className={className} />
)
...
export const ProToolsIcon: React.FC<DawIconProps> = ({ className }) => (
  <img src="/assets/daw-logos/pro-tools.png" alt="Pro Tools" className={className} />
)
...
export const BitwigIcon: React.FC<DawIconProps> = ({ className }) => (
  <img src="/assets/daw-logos/bitwig.png" alt="Bitwig" className={className} />
)

export const ReaperIcon: React.FC<DawIconProps> = ({ className }) => (
  <img src="/assets/daw-logos/reaper.png" alt="Reaper" className={className} />
)
