...
export function VideoFeatureHighlights() {
              ...
              {feature.videoSrc && (
                <div className="flex-1 lg:max-w-md relative z-10">
                  <div className="aspect-video relative rounded-lg overflow-hidden bg-zinc-100 dark:bg-zinc-800">
                    ...
                    {/* Play button overlay */}
                    <div className="absolute inset-0 flex items-center justify-center bg-black/20 transition-opacity duration-300 hover:bg-black/10">
                      <div className="bg-white/90 dark:bg-zinc-900/90 rounded-full p-3 shadow-lg transition-transform duration-200 hover:scale-110">
                        <Play size={20} weight="fill" className="text-zinc-900 dark:text-white ml-0.5" />
                      </div>
                    </div>
                  </div>
                </div>
