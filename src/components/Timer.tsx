...
export default function Timer() {
  ...
  return (
    <div className="bg-white dark:bg-card rounded-xl p-3 animate-fade-in theme-transition h-[480px] min-h-[480px] max-h-[480px] flex flex-col relative z-10 -mt-1 shadow-sm" style={{ height: '480px', minHeight: '480px', maxHeight: '480px' }}>
