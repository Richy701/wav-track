...
import { 
  ChevronDown, ChevronUp, HelpCircle, Globe, Phone, MapPin,
  Music, Mic2, Radio, Drum, Guitar, Piano, Waveform, RadioReceiver,
  Music2, Radio2, Drumstick, Guitar2, Piano2, Waveform2, RadioReceiver2
} from 'lucide-react';
...
const daws = [
  { value: 'ableton', label: 'Ableton Live', description: 'Perfect for live performance and electronic music' },
  ...
  { value: 'pro-tools', label: 'Pro Tools', description: 'Industry standard for professional recording' },
];
...
export function SignUp() {
  ...
  const generateStageName = () => {
    const adjectives = ['Mystic', 'Cosmic', 'Urban', 'Digital', 'Neon', 'Crystal', 'Shadow', 'Golden'];
